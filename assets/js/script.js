...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Shanya Jain";
...
var typed = new Typed(".typing-text", {
    strings: ["frontend development", "web designing","UI/UX designing", "web development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showProjects(projects) {
    ...
    let projectHTML = "";
    projects.slice(0, 6).filter(project => project.category != "abc").forEach(project => {
        projectHTML += `
        <div class="box tilt">
